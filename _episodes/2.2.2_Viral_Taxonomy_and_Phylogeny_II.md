...
> 
> {:start='2'}
> 2. Add your terL sequences to the reference alignment using mafft. You need the following command and it will take ~22min
>
> ```bash
...
The above commands produce a tree in a newick format. This can be opened with dendroscope (if you downloaded it locally) or [iTOL](https://itol.embl.de/) or another tree-visualization software. This tree will have >5000 leaves so it will be quite large.
...
>
>{:start='10'}
> 10. What do long branches on your terL tree mean?
> 11. Where are the contigs assigned to long branches in the network from vConTACT3? 
> 12. What percentage of your total viral contigs were classified by vConTACT3?
> 13. How can you judge the accuracy of your taxonomic classifications?
> 14. What is the maximum taxonomic distance between viruses that are still connected in the vConTACT3 graph? 
> 15. What are the limitations of using the terL tree?
> {: .source}
{: .challenge}
