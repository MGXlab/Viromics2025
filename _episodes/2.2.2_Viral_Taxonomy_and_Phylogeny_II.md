...
> 
> {:start='4'}
> 4. Build a tree using FastTree. **Please include a graphic of tree in your lab books with your own contigs labeled or highlighted somehow.**
> 
> ```bash
...
The above commands produce a tree in a newick format. This can be opened with dendroscope (if you downloaded it locally) or [iTOL](https://itol.embl.de/) or another tree-visualization software. This tree will have >5000 leaves so it will be very large.
...
> 
>{:start='6'}
>6. What percentage of your total viral contigs were classified by vConTACT3?
>7. How can you judge the accuracy of your taxonomic classifications?
>8. What is the maximum taxonomic distance between viruses that are still connected in the vConTACT3 graph?
>
> **Pick one pet viral contig that has a terL gene and also a taxonomic classification by vConTACT3**
>
>{:start='9'} 
>9. What is the taxonomy classifcation of your *pet contig* from vConTACT3 and the terL tree?
>10. How many genes are shared with known reference viruses? *(vConTACT3 results)*
>11. If your classifications are/were different between the terL tree and the vConTACT3 - which classification would you trust more?
>
> ### Optional/Group Discussions
> 
>{:start='12'}
>12. Explore the cytoscape network visualization and/or terL tree together
>13. What do long branches on your terL tree mean?
>14. Where are the contigs assigned to long branches in the network from vConTACT3? 
