...
![example_qc_nanoplot](../assets/img/LengthvsQualityScatterPlot_dot.png)


> ## Exercise
> 
> {:start="5"}
> 5. How does the sequencing quality of the 2 samples compare to each other? Specify your answer with metrics from the NanoPlot results.
