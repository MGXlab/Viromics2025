...
Allocate 20 threads and at least 20 GB memory for the sbatch job. It should take only a few seconds to run.
...
> 6. What are reasons for contigs with low completeness to appear in the assembly?
> 7. How do completeness and contig coverage relate? (qualitative answer, name examples)
{: .challenge}
