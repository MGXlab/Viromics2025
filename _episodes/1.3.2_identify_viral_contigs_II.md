...
questions: 
objectives:
- "Identify phage contigs in assembled virome"
...
To get a command to get the sequence of a contigID, you could go to "Extract contig fasta" of the tutorial of [Gene Calling and Functional Annotation II](https://mgxlab.github.io/Viromics2024/1.4.2_gene_finding/index.html).
...
>assembly='./1.2_assembly/10_results_assembly_flye/single_assemblies/barcode62.fasta'
>
>checkv end_to_end -t 20 -d $database $assembly $outdir/single_assemblies
> ```
> {: .source}
{: .solution}
...
>
> {:start="6"}
> 5. How are completeness and length related? (qualitative answer, name examples)
> 6. What are possible reasons for contigs with low completeness to appear in the assembly?
{: .challenge}
...
>#SBATCH --output=./1.3_virus_identification/30_results_filter_contigs/filter_contigs.slurm.%j.out
>#SBATCH --error=./1.3_virus_identification/30_results_filter_contigs/filter_contigs.slurm.%j.err
>
...
># for readability
>assembly='1.2_assembly/10_results_assembly_flye/single_assemblies/barcode62.fasta'
>jaegerresults='./1.3_virus_identification/10_jaeger/results_jaeger/barcode62/barcode62_default_jaeger.tsv'
>checkvresults='1.3_virus_identification/20_results_assessment_checkv/single_assemblies/quality_summary.tsv'
>outdir='./1.3_virus_identification/30_results_filter_contigs'
>
># run our script for filtering contigs based on the output of jaeger
># and CheckV as well as the output path. 
>python ./python_scripts/identify/filter_contigs.py $assembly $jaegerresults $checkvresults $outdir/assembly.fasta
>
...
> 
>{:start="9"}
> 7. At the selected cutoffs, how many contigs get chosen by jaeger, how many by CheckV?
> 8. How many Jaeger hits were annotated by CheckV as having high-quality?
{: .challenge}
